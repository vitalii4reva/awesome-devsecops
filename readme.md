...
- [Git AutoReview](https://gitautoreview.com) - _Git AutoReview_ - AI-powered code review VS Code extension with 20+ built-in security rules (OWASP Top 10), BYOK privacy model, and support for GitHub, GitLab and Bitbucket.
